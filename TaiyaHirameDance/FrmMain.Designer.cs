namespace TaiyaHirameDance
{
    partial class FrmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            MainPanel.Controls.Add(lblRecipeNo);
            ...
            // lblRecipeNo
            // 
            lblRecipeNo.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            lblRecipeNo.Font = new Font("Arial", 24F, FontStyle.Bold | FontStyle.Italic, GraphicsUnit.Point, 0);
            lblRecipeNo.Location = new Point(12, 2);
            lblRecipeNo.Name = "lblRecipeNo";
            lblRecipeNo.Size = new Size(530, 36);
            lblRecipeNo.TabIndex = 7;
            lblRecipeNo.Text = "RecipeNo";
            lblRecipeNo.UseMnemonic = false;
            // 
            // DbSnapshot
            // 
